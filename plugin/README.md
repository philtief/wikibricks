...
From a clone of [wikibricks-dev](https://github.com/philtief/wikibricks-dev):
...
> Marketplace will move to public [philtief/wikibricks](https://github.com/philtief/wikibricks)
> after stabilization. See AGENTS.md "Dev → public sync checklist" for
> the URL flip.
...
| :------------------------ | :----------------------------------------------- | :--------------------------------------------------------------- |
| `WIKIBRICKS_PLUGIN_REF`   | `v0.3.0`                                         | Git ref the launcher installs. Override for bleeding-edge.       |
| `WIKIBRICKS_PLUGIN_GIT`   | `https://github.com/philtief/wikibricks-dev.git` | Git URL the launcher installs from.                              |
